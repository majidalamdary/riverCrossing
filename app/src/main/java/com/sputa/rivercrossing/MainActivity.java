...
//        lbl_timer.setTypeface(tf);
    ...
    private void set_level_rule_and_help()
    {
        ...
        level_rules[1]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[2]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[3]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[4]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[5]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[6]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[7]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[8]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[9]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[10]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[11]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[12]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[13]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[14]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
        ...
        level_rules[15]+="جایزه اتمام مرحله (فقط یکبار) :"+'\n';
